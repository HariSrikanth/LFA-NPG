...
class QNPG:  # Code to execute QNPG Code
    ...
    def reg(self, x, y):
        ...
        regPredictor = np.poly1d(np.polyfit(newx, newy, 4))
...
rewarded = 0
for i in range(1000):
    rewarded += agent.episodicTimeUp([-5.32552342e+01, -1.06221093e+01, 3.22093019e-02, 6.12411661e+01,
...
average_regTime = totalRegtime / 20
averageruntime = totalruntime / 20
average_reward[0] = 0
value_mat[0, :] = 0
